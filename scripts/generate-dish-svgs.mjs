...
const dishes = [
  // Photo dishes (.webp): orchard-pancake, trout-toast, market-greens, chicken-sandwich, halloumi-bites, maple-chicken, tomato-farro, garden-scramble, mushroom-benny, citrus-granola, cedar-salmon, squash-soup
