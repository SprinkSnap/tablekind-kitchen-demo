...
export const MENU_ITEMS: MenuItem[] = [
  {
    ...
    price: 18,
    category: 'brunch',
    image: '/images/dishes/orchard-pancake.svg',
    imageAlt: 'Stack of golden pancakes with apples and maple cream',
  ...
  },
  {
    ...
    price: 19,
    category: 'brunch',
    image: '/images/dishes/trout-toast.svg',
    imageAlt: 'Open-faced smoked trout toast with herbs',
    dietaryLabels: [],
    featured: true,
    availableForPickup: true,
  ...
  },
  {
    ...
    price: 16,
    category: 'lunch',
    image: '/images/dishes/market-greens.svg',
    imageAlt: 'Fresh green salad with roasted squash',
    dietaryLabels: ['vegetarian', 'gluten-conscious'],
    featured: true,
    availableForPickup: true,
  ...
  },
  {
    ...
    price: 18,
    category: 'lunch',
    image: '/images/dishes/chicken-sandwich.svg',
    imageAlt: 'Herb chicken sandwich cut in half',
    dietaryLabels: [],
    featured: true,
    availableForPickup: true,
    modifiers: [extraGreens, makeSpicy],
  ...
  },
  {
    ...
    image: '/images/dishes/halloumi-bites.svg',
    imageAlt: 'Crispy halloumi bites with chilli honey',
    dietaryLabels: ['vegetarian', 'gluten-conscious'],
    featured: true,
    availableForPickup: true,
  ...
  },
  {
    ...
    price: 28,
    category: 'mains',
    image: '/images/dishes/maple-chicken.svg',
    imageAlt: 'Roasted chicken with polenta and greens',
    dietaryLabels: ['gluten-conscious'],
    featured: true,
    availableForPickup: true,
